    ...
    <div >
       ...
       <div style="margin-left:100px;margin-top:10px; width: 400px;">         
        ...
        <div style="margin-left:100px;margin-top:10px;width: 400px;">         
          ...
          -->  </div>
        <div style="margin-left:100px;margin-top:10px;width: 400px;">       
           <asp:Label  runat="server"  Text="Meter-4:" Font-Size="30" Height="50px" Width="150px"></asp:Label>
            <asp:Label ID="Label4" runat="server" Text="ON" Font-Size="30" Height="50px" Width="150px"></asp:Label>
          ...
          -->  </div>
        <div style="margin-left:100px;margin-top:10px;width: 400px;">         
           <asp:Label runat="server" Text="Meter-5:" Font-Size="30" Height="50px" Width="150px"></asp:Label>
            <asp:Label ID="Label5" runat="server"  Text="ON" Font-Size="30" Height="50px" Width="150px"></asp:Label>
           ...
           --> </div>
        <div style="margin-left:100px;margin-top:10px;width: 400px;">         
           <asp:Label  runat="server" Text="Meter-6:" Font-Size="30" Height="50px" Width="150px"></asp:Label>
            <asp:Label ID="Label6" runat="server" Text="ON" Font-Size="30" Height="50px" Width="150px"></asp:Label>
